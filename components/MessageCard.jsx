...
const MessageCard = ({ message }) => {
    ...
    return (
        <div className="relative bg-whire p-4 rounded-md shadow-md border border-gray-200">
            {!isRead && (
            ...
            <ul className="mt-4">
                ...
                <li>
                    ...
                    <a href="{`mailto:${messge.email}`}" className="text-blue-500">{message.email}</a>
                </li>
                <li>
                    <strong>Reply Phone:</strong>{' '}
                    <a href="{`tel:${messge.phone}`}" className="text-blue-500">{message.phone}</a>
                </li>
                <li>
