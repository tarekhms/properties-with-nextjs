            ...
            <div>
                ...
                <div className="flex justify-center gap-4 text-gray-500 mb-4">
                    <p>
                        ...
                        <span className="md:hidden xl:inline">Beds</span>
                    </p>
                    <p>
                        <FaBath className="inline-block mr-2" /> {property.baths}{' '}
                        <span className="md:hidden xl:inline">Baths</span>
                    </p>
                    <p>
                        <FaRulerCombined className="inline-block mr-2" /> {property.square_feet}{' '}
                        <span className="md:hidden xl:inline">sqft</span>
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between">
                    <div className="flex align-middle gap-2 mt-1 lg:mb-0">
